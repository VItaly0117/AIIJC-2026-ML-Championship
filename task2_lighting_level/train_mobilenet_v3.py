...
print("=================================================================", flush=True)
print("MOBILENET_V3-SMALL TRAINING (NO COLOR JITTER)", flush=True)
print("=================================================================", flush=True)
...
print("\n" + "=" * 65, flush=True)
print(f"MobileNetV3-Small OOF Accuracy : {oof_acc:.4f}", flush=True)
...
out_path = 'd:/AIJC/submission_task2_mobilenet_v3.csv'
